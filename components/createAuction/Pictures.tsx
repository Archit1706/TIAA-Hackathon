    ...
    <div className="mt-8 p-4">
      ...
      <div className="flex p-2 mt-4">
        ...
        <div className="flex-auto flex flex-row-reverse">
          <button onClick={formSubmitHandler} className="text-base  ml-2  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-mobile bg-mobile text-mobile-light border duration-200 ease-in-out border-mobile transition">Submit</button>
        </div>
      </div>
    </div>
  )
