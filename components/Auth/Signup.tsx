                    ...
                    <div className="w-[500px] bg-white rounded-lg drop-shadow-lg">
                        <div className="space-y-2 py-10 px-10">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-4" >
                                ...
                                <button type="submit" className="w-full text-white bg-mobile hover:bg-violet-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center">
                                    Sign Up
                                </button>
                                <hr />
                                <p className="text-base font-normal text-gray-800">
                                    Alreay have an account ? <a href="/login" className="font-medium text-lg text-mobile hover:underline ">Login</a>
                                </p>
                            </form>
                        </div>
                    </div>
